...
<p class="comment">
    <code>src/tag/tag-filter.component.ts</code>
</p>
    ...
    <p class="comment">
            <code><a href="../components/Tag.html" target="_self" >Tag</a></code>
    </p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-tag-filter</code></td>
            </tr>
                        ...
                        <p>
                            ...
                            <tr>
                                <td class="col-md-4" colspan="2">
                                    <div class="io-line">Inherited from     <code><a href="../components/Tag.html" target="_self" >Tag</a></code>
</div>
                                </td>
                            </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in Tag:31</div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>type of the tag determines the styling</p>
<p>Reference <code>TagType</code> for v9 applications, and <code>TagTypeExperimental</code> for v10/v9 experimental mode applications</p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="../components/Tag.html" target="_self" >TagType</a></code>

                            </p>
                        <p>
                            <em>Default value : </em><code>&quot;gray&quot;</code>
                        </p>
                    </td>
                </tr>
                            <tr>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in Tag:29</div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>We need to stop the immedate propagation of click on the close button
...
to on the immediate close button element.</p>
</div>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="41" class="link-to-prism">src/tag/tag-filter.component.ts:41</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>attr.class:     <code></code>
</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="49" class="link-to-prism">src/tag/tag-filter.component.ts:49</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in Tag:33</div>
                            </td>
                        </tr>
...
<code>onClose(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="43" class="link-to-prism">src/tag/tag-filter.component.ts:43</a></div>
                            </td>
                        </tr>
...
<script>
        var COMPONENT_TEMPLATE = '<div><ng-content></ng-content><svg	(click)="onClose($event)"	focusable="false"	preserveAspectRatio="xMidYMid meet"	style="will-change: transform;"	xmlns="http://www.w3.org/2000/svg"	aria-label="Clear filter"	width="16"	height="16"	viewBox="0 0 16 16"	role="img">	<path d="M12 4.7l-.7-.7L8 7.3 4.7 4l-.7.7L7.3 8 4 11.3l.7.7L8 8.7l3.3 3.3.7-.7L8.7 8z"></path></svg>	</div>'
...
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'TagFilter.html';
       </script>
