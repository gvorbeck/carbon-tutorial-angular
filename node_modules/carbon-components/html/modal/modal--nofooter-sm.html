...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dnz3bud9c6a">Show
  modal</button>

<div data-modal id="modal-dnz3bud9c6a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dnz3bud9c6a-label" aria-describedby="modal-dnz3bud9c6a-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dnz3bud9c6a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dnz3bud9c6a-heading">Modal heading</p>
