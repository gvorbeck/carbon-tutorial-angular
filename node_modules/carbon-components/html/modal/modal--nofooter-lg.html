...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-odpwh2d0jv">Show
  modal</button>

<div data-modal id="modal-odpwh2d0jv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-odpwh2d0jv-label" aria-describedby="modal-odpwh2d0jv-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-odpwh2d0jv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-odpwh2d0jv-heading">Modal heading</p>
