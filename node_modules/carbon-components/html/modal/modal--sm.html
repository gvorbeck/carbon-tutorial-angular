...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rp04m2nvede">Show
  modal</button>

<div data-modal id="modal-rp04m2nvede" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rp04m2nvede-label" aria-describedby="modal-rp04m2nvede-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rp04m2nvede-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rp04m2nvede-heading">Modal heading</p>
