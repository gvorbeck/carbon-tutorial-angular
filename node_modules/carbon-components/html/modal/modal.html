...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-n7xufcjw0i">Show
  modal</button>

<div data-modal id="modal-n7xufcjw0i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-n7xufcjw0i-label" aria-describedby="modal-n7xufcjw0i-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n7xufcjw0i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n7xufcjw0i-heading">Modal heading</p>
