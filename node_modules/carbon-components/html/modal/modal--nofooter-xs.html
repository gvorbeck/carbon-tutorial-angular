...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-muy9t0i4tw">Show
  modal</button>

<div data-modal id="modal-muy9t0i4tw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-muy9t0i4tw-label" aria-describedby="modal-muy9t0i4tw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-muy9t0i4tw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-muy9t0i4tw-heading">Modal heading</p>
