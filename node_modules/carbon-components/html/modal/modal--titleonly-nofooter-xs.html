...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sk7mgufwv3m">Show
  modal</button>

<div data-modal id="modal-sk7mgufwv3m" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sk7mgufwv3m-label" aria-describedby="modal-sk7mgufwv3m-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sk7mgufwv3m-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sk7mgufwv3m-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
