...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-driehd792gf">Show
  modal</button>

<div data-modal id="modal-driehd792gf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-driehd792gf-label" aria-describedby="modal-driehd792gf-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-driehd792gf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-driehd792gf-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-driehd792gf" class="bx--label">Text Input label</label>
        <input id="text-input-driehd792gf" type="text" class="bx--text-input" placeholder="Optional placeholder text"
