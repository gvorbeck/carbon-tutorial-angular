...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-el1qt94wbpo">Show
  modal</button>

<div data-modal id="modal-el1qt94wbpo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-el1qt94wbpo-label" aria-describedby="modal-el1qt94wbpo-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-el1qt94wbpo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-el1qt94wbpo-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
