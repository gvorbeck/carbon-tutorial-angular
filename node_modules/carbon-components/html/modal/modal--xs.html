...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-76gldnv0obm">Show
  modal</button>

<div data-modal id="modal-76gldnv0obm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-76gldnv0obm-label" aria-describedby="modal-76gldnv0obm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-76gldnv0obm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-76gldnv0obm-heading">Modal heading</p>
