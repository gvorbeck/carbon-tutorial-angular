...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-oyzfqdmfrq">Show
  modal</button>

<div data-modal id="modal-oyzfqdmfrq" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-oyzfqdmfrq-label" aria-describedby="modal-oyzfqdmfrq-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-oyzfqdmfrq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-oyzfqdmfrq-heading">Modal heading</p>
