...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ekyj3abanu">Show
  modal</button>

<div data-modal id="modal-ekyj3abanu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ekyj3abanu-label" aria-describedby="modal-ekyj3abanu-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ekyj3abanu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ekyj3abanu-heading">Modal heading</p>
