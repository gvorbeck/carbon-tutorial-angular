...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rpyoshoyth8">Show
  modal</button>

<div data-modal id="modal-rpyoshoyth8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rpyoshoyth8-label" aria-describedby="modal-rpyoshoyth8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rpyoshoyth8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rpyoshoyth8-heading">Modal heading</p>
